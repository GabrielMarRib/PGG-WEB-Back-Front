    ...
    if (
      ...
      try {
        const response = await axios.post("http://pggzettav3.mooo.com/api/index.php", {
          ...
          idProduto: idProduto,
          Valor_despesas_Anuais: Valor_despesas_Anuais,
          Quantia_Produtos_Estocados: Quantia_Produtos_Estocados,
          Numero_Pedidos_Anuais: Numero_Pedidos_Anuais,
          demanda_anual: demanda_anual,
        });
        console.log("Resposta da inserção: ", response);
        Alerta(2, "Dados Atualizados");

        await pegaDadosLoteEconomico();
      } catch (error) {
