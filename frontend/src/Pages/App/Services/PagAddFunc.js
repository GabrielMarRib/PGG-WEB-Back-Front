...
function PagAddFunc() {
    ...
    const handleSubmit = async (e) => {
        ...
        const [msg, erro] = await handleAdicionarUser(nome, cpf, email, telefone, parseInt(selectedAccess), User);
        alert(msg);
    }
        ...
        <div className='PagAddFunc'>
            ...
            {User && User.userData && User.userData.Nivel_acesso && User.userData.Nivel_acesso == 2 ? (
                <form className="formAddFunc" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <p>
                        <h2>Nome:</h2>
                        <input id='inNome' type="text" required
                            value={nome}
                    ...
                    <p>
                        <h2>Telefone:</h2>
                        <InputMask id='inTelefone' required
                            value={telefone}
                            onChange={(e) => {
                                setTelefone(e.value)
                            }}
